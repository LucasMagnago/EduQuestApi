...
namespace EduQuest.Infrastructure.Migrations
{
    ...
    [Migration("20250508012923_AjusteNaConquista")]
    partial class AjusteNaConquista
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduQuest.Domain.Entities.AlunoEstatistica", b =>
                {
                    b.Property<int>("AlunoId")
                        .HasColumnType("int");

                    b.Property<int>("AtividadesConcluidas")
                        .HasColumnType("int");

                    b.Property<double>("MediaNotasNormalizadas")
                        .HasColumnType("float");

                    b.Property<int>("QuantidadeNotasValidas")
                        .HasColumnType("int");

                    b.Property<int>("TotalParticipacoesInBatalhas")
                        .HasColumnType("int");

                    b.Property<int>("TotalVitoriasInBatalhas")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduQuest.Domain.Entities.AlunoPossuiItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AlunoId = 5,
                            DataAquisicao = new DateTime(2025, 4, 12, 10, 20, 0, 0, DateTimeKind.Unspecified),
                            ItemId = 1
                        },
                        new
                        {
            ...
            modelBuilder.Entity("EduQuest.Domain.Entities.EscolaEstatistica", b =>
                {
                    b.Property<int>("EscolaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduQuest.Domain.Entities.TurmaEstatistica", b =>
                {
                    b.Property<int>("TurmaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduQuest.Domain.Entities.AlunoEstatistica", b =>
                {
                    b.HasOne("EduQuest.Domain.Entities.Aluno", "Aluno")
                        .WithOne()
                        .HasForeignKey("EduQuest.Domain.Entities.AlunoEstatistica", "AlunoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EduQuest.Domain.Entities.EscolaEstatistica", b =>
                {
                    b.HasOne("EduQuest.Domain.Entities.Escola", "Escola")
                        .WithOne()
                        .HasForeignKey("EduQuest.Domain.Entities.EscolaEstatistica", "EscolaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EduQuest.Domain.Entities.TurmaEstatistica", b =>
                {
                    b.HasOne("EduQuest.Domain.Entities.Turma", "Turma")
                        .WithOne()
                        .HasForeignKey("EduQuest.Domain.Entities.TurmaEstatistica", "TurmaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
