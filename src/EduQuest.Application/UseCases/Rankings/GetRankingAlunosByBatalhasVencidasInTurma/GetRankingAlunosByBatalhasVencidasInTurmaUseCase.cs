...
{
    internal class GetRankingAlunosByBatalhasVencidasInTurmaUseCase : IGetRankingAlunosByBatalhasVencidasInTurmaUseCase
    {
        private readonly IRankingRepository _rankingRepository;
        private readonly IMapper _mapper;

        public GetRankingAlunosByBatalhasVencidasInTurmaUseCase(IRankingRepository rankingRepository,
            IMapper mapper)
        {
